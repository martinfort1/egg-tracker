...
export class BuyersController {
  ...
  @UseGuards(JwtGuard)
  @Post()
  createBuyer(@GetUser('id') userId: string, @Body() dto: CreateBuyerDto) {
  ...
  @Get('/debts')
  @UseGuards(JwtGuard)
  findDebtors(@GetUser('id') userId: string) {
  ...
  @Get(':id/history')
  @UseGuards(JwtGuard)
  getBuyerHistory(@Param('id') id: string, @GetUser('id') userId: string) {
  ...
  @Delete(':id')
  @UseGuards(JwtGuard)
  deleteBuyer(@Param('id') id: string, @GetUser() user: { id: string }) {
